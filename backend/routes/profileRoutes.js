...
import { changeDP, deleteProfile, editProfile, followToggle, getAllProfiles, getProfile, getSavedItems, removeDP } from "../controllers/profileController.js";
...
router.delete("/delete-profile", authUser, deleteProfile);
