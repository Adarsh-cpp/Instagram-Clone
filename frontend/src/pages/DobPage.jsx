...
// Runs once on module load rather than on every submit
...
const DobPage = () => {
  ...
  return (
    <div className="dobPage h-[100vh] w-[100vw] flex justify-center items-center bg-[#0c1014]">
      <div className="dobContainer w-[350px] h-[550px] flex flex-col justify-between ">
        <div className="topPart h-[84%] w-full border border-[#363636]">
            ...
            <div className="cake w-full h-[180px] flex flex-col items-center ">
                ...
                <div className="text mt-1 text-white text-[14px] font-bold">Add your date of birth</div>
                <div className="text2 mt-3 text-white text-[16px]">This won't be part of your public profile</div>
            </div>
        ...
        {years.map((year) => (
          <option key={year} value={year}>{year}</option>
            ...
            <div className="text w-full h-[90px]">
              <p className="text-[12px] text-[#A8A8A8] text-center mt-1">You need to enter the date you were born on</p>
              <p className="text-[12px] text-[#A8A8A8] text-center mt-5">Use your own date of birth, even if this account is for a <br />business, pet or something else</p>
            </div>
            
            <div className="btns w-full h-[125px] flex flex-col justify-center items-center gap-2">
              <div onClick={() => formRef.current.requestSubmit()} className="nextBtn w-[75%] h-[35px] flex justify-center items-center rounded-[10px] bg-[#0095f6] hover:bg-[#1877f2] text-[#ffffff] font-bold cursor-pointer">Next</div>
              <div className="backBtn w-[75%] h-[35px] flex justify-center items-center rounded-[10px] font-bold "><span className="text-[#0095f6] hover:text-[#1877f2] cursor-pointer"><Link to="/user/signup">Go back</Link></span></div>
            </div>
